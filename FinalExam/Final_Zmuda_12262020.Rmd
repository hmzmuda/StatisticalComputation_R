...
#bootstrap percentile, student, BCAa 95% CI
library(boot)
B <- 1000
y.a <- chain[,1]
y.b <- chain[,2]
...
```
 ...
 in many situations alternative methods outperform the percentile bootstrap (such as percentile-t, bias corrected, bias corrected & accelerated (BCa), wild bootstraps)
