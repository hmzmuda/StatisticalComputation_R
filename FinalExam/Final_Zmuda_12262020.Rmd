...
for(i in 2:N){
  ...
  reults.m<- rbind(result.m,c(alpha[i],beta[i],mu[i],lambda[i]))
}
...
```
Becuase the proposal distribution is symmetric, it can be canceled out in the 
