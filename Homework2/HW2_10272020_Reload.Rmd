...
new.oil <- function(N,b1,b2,dl,d2l,tol){
  ...
  theta.old <- c(1,1)
  for(i in 1:n){
    theta.new = theta.old - dl(N,b1,b2,theta.old)/d2l(N,b1,b2,theta.old)
...
fish.oil <- function(N,b1,b2,dl,I,tol){
  ...
  theta.old <- c(1,1)
  for(i in 1:n){
    theta.new = theta.old + dl(N,b1,b2,theta.old)/I(N,b1,b2,theta.old)
    if(abs(a-a0) <= tol){
...
ouput.fish <- fish.oil(N,b1,b2,dl,I,1e-5)
