...
#output
hist(beta.hat,breaks = 40, main = "Beta from Boostrap with Residuals", xlab = "Beta Estimate")
...
hist(beta.new,breaks = 40, main = "Beta from Boostrap with Cases", xlab = "Beta Estimate")
