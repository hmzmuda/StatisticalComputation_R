...
powA <- power.t.test(m, delta = pHatA, sig.level = 0.05, power = NULL, alternative = "two.sided")
powB <- power.t.test(m, delta = pHatB, sig.level = 0.05, power = NULL, alternative = "two.sided")
powC <- power.t.test(m, delta = pHatC, sig.level = 0.05, power = NULL, alternative = "two.sided")

for(j in 1:m){
  #how do I get multiple means and powers when I am using the one pHat calculated in part a?
