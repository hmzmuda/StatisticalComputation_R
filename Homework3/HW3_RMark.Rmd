...
dfA <- data.frame(mu1,powA,"Chi Squared")
dfB <- data.frame(mu1,powB, "Uniform")
dfC <- data.frame(mu1,powC, "Exponential")
dfNorm <- data.frame(mu1,powNorm, "Normal")
data <- rbind(dfA, dfB, dfC, dfNorm)

# ggplot(data = data, aes(x = mu1, y = powA), col = "red") +
#   geom_point(data = dfA, aes(x = mu1, y = powA), col = "red") +
#   geom_point(data = dfB, aes(x = mu1, y = powB), col = "blue") +
#   geom_point(data = dfC, aes(x = mu1, y = powC), col = "yellow") +
#   geom_point(data = dfNorm, aes(x = mu1, y = powNorm), col = "green") +
