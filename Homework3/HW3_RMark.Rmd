...
cat("Jackknife Bias Estimate:", (n-1)*(se.beta.bar-sd(beta.hat)),"\n")
cat("Estimate of bias:", (n-1)*(se.beta.bar-sd(beta.hat)),"\n")
...
### part iv.
Yes, because m-out-n bootstrap uses the likelihood as the bootstrap statistic which we showed in part i that it depends on $\theta$.
